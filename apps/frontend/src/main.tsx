...
console.log(
  "%cBetterLibmanan.org%c — Official Portal of Libmanan, Camarines Sur",
  ACCENT,
  RESET,
);
console.log(
...
console.log(
  "%cEnvironment %c" + (import.meta.env.MODE ?? "development"),
  BOLD,
  RESET,
);
console.log(
  "%cPlatform    %cReact 18 · Vite · TypeScript · TailwindCSS",
  BOLD,
  RESET,
);
...
console.log(
  "%cCreated & maintained by %cenzox0/BetterLibmanan.org Team",
  RESET,
  ACCENT,
);
console.log(
  "%cRepository  %chttps://github.com/enzox0/betterlibmanan",
  BOLD,
  RESET,
);
console.log(
