...
function BrgyBar({
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="w-6 text-right text-xs font-bold text-gray-400">
        #{rank}
      </span>
...
function BrgySection({
  ...
  const filtered = useMemo(() => {
    ...
    const base = q
      ? data.filter((b) => b.name.toLowerCase().includes(q))
      : data;
    ...
    <section className="py-10 sm:py-14">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="h-1.5 w-full rounded-full bg-gray-100 overflow-hidden">
                      <motion.div
                        ...
                        initial={{ width: 0 }}
                        whileInView={{
                          width: `${(brgy.population / maxPop) * 100}%`,
                        }}
                        viewport={{ once: true }}
                        transition={{
                          duration: 0.7,
        ...
        <p className="text-[11px] text-gray-400 mt-4">
          Source: Philippine Statistics Authority (PSA) — 2020 Census; PhilAtlas
          barangay profiles
        </p>
      </div>
    </section>
...
export function StatisticsPage() {
  ...
  const maxBrgyPop = Math.max(
    ...data.barangayPopulation.map((b) => b.population),
  );
  const sortedBrgy = [...data.barangayPopulation]
    ...
    <div className="min-h-screen bg-neutral-100">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-3">
            ...
            >
              ...
              <DonutRing
                pct={data.finance.composition[0].percentage}
                size={110}
                stroke={14}
                label={`${data.finance.composition[0].percentage}%`}
              />
      ...
      <section className="py-10 sm:py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-end justify-between mb-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      90% CI: {poverty.confidenceInterval}
                    </p>
                  </div>
                  <DonutRing
                    pct={poverty.rate}
                    color={
                      poverty.status === "improved" ? "#16a34a" : "#dc2626"
                    }
                    size={72}
                    stroke={9}
                    label={`${poverty.rate}%`}
          ...
          <p className="text-[11px] text-gray-400 mt-4">
            Source: Philippine Statistics Authority (PSA) — 2021 Poverty
            Estimates
          </p>
        </div>
      </section>
