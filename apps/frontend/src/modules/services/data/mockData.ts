...
export const mockServicesData: ServicesData = {
  categories: [
    ...
    },
    {
      ...
      slug: "tax-payments",
      description:
        "Property tax, business tax, and other municipal tax payments",
      icon: FaMoneyBill,
      services: [
        {
          ...
          requirements: ["Tax Declaration", "Previous OR (if applicable)"],
          steps: [
        ...
        },
        {
          ...
          requirements: ["Business permit", "Previous year's OR"],
          steps: [
