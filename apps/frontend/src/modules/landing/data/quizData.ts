...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['3rd Class Municipality', '2nd Class Municipality', '1st Class Municipality', 'Component City'],
    correctIndex: 2,
    explanation:
  ...
  {
    id: 3,
    question: 'Which famous natural attraction in Libmanan features dramatic stalactite formations?',
    options: ['Sipocot Cave', 'Libmanan Cave', 'Palestina Cavern', 'Bicol Underground Cave'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Region IV-A (CALABARZON)', 'Region VIII (Eastern Visayas)', 'Region V (Bicol)', 'Region VI (Western Visayas)'],
    correctIndex: 2,
    explanation:
  ...
  {
    id: 5,
    question: 'What is the famous Spanish colonial church in Libmanan dedicated to?',
    options: ['San Isidro Labrador', 'Santo Niño', 'San Pedro Apostol', 'Santa Rosa de Lima'],
    correctIndex: 2,
    explanation:
  ...
  {
    id: 6,
    question: 'Which iconic Bicolano dish is made of taro leaves wrapped around pork or fish in coconut cream?',
  ...
  {
    id: 8,
    question: 'What type of nut is a prized agricultural product and popular pasalubong from Camarines Sur?',
  ...
  {
    id: 10,
    question: 'What is the primary local language spoken in Libmanan alongside Filipino and English?',
