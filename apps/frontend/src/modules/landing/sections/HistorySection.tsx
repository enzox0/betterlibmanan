...
export function HistorySection({ isLoading = false }: { isLoading?: boolean }) {
  ...
  const visibleTimeline = isExpanded ? historyTimeline : historyTimeline.slice(0, 4);
                ...
                <div className="relative pl-6">
                  ...
                  <div className="space-y-4">
                    {visibleTimeline.map((item) => (
                      <div key={item.year} className="relative rounded-xl border border-neutral-200 bg-white p-5 shadow-sm">
                        <div className="absolute left-[-1.15rem] top-6 h-3 w-3 rounded-full border-2 border-neutral-900 bg-white" />
