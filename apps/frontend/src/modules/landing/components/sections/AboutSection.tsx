...
const betterGovTools = [
    ...
    },
    {
        ...
        description: 'Centralizing government datasets for research and accountability.',
    ...
    },
    {
        ...
        description: 'A directory of civic transparency portals across the country.',
    ...
    return (
        <div className="bg-white">
            ...
            <section className="relative bg-gray-900 overflow-hidden">
                ...
                >
                    ...
                    <p className="mt-5 max-w-2xl text-base sm:text-lg text-gray-300 text-center lg:text-left leading-relaxed">
                        A free, volunteer-built civic transparency portal for the people of Libmanan, Camarines Sur — part of the{' '}
                        <a
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="mt-3 text-sm sm:text-base text-neutral-500 max-w-3xl leading-relaxed">
                            BetterLibmanan.org is an independent, civic-technology website that makes local government
                            information about Libmanan — budgets, ordinances, officials, barangay data, and public services
                            — easy for any resident to find and understand.
                        </p>
                        <p className="mt-3 text-sm sm:text-base text-neutral-500 max-w-3xl leading-relaxed">
                            It is not an official LGU website. It is built by volunteers and is entirely open source. All
                            data is sourced from public government portals such as the Commission on Audit (COA), the DBM
                            Open Data portal, the Official Gazette, and LGU Libmanan's own published records.
                        </p>
                    </motion.div>
            ...
            <section className="py-16 bg-neutral-50 border-y border-neutral-200">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <motion.div {...fadeUp} className="lg:grid lg:grid-cols-[minmax(0,1fr)_340px] lg:gap-12 lg:items-start">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                <img src="/bettergov-logo.svg" alt="BetterGov.ph" className="h-8 w-auto opacity-80" />
                            ...
                            <p className="mt-3 text-sm sm:text-base text-neutral-500 leading-relaxed max-w-2xl">
                                BetterGov.ph is a volunteer-driven civic technology and open source movement making Philippine
                                government data accessible, understandable, and actionable. It is not an organization — it is
                                a network of developers, researchers, and citizens who believe every Filipino deserves
                                transparent, accountable government.
                            </p>
                            <p className="mt-3 text-sm sm:text-base text-neutral-500 leading-relaxed max-w-2xl">
                                BetterLibmanan is part of the{' '}
                                <strong className="text-neutral-700">Better LGU</strong> program — a community-maintained
                                network of civic portals covering local governments across the Philippines. Each portal is
                                independently run by local volunteers and listed in the{' '}
                                <a
                                    href="https://lgu.bettergov.ph"
                                    target="_blank"
                                    rel="noopener noreferrer"
                        ...
                        <div className="mt-10 lg:mt-0 space-y-3">
                            ...
                            {betterGovTools.map((tool) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="text-sm font-semibold text-neutral-900">{tool.name}</p>
            ...
            <section className="py-16 bg-white">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="mt-3 text-sm sm:text-base text-neutral-500 max-w-3xl leading-relaxed">
                            BetterLibmanan is part of a growing network of civic portals built by volunteers across the
                            Philippines. Each portal covers a different city or municipality — all free, all open source,
                            all maintained by the community.
                        </p>
                    </motion.div>
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="mt-3 text-sm sm:text-base text-neutral-500 max-w-2xl leading-relaxed">
                            BetterLibmanan is only as good as the people who build and maintain it. Here's how you can help.
                        </p>
                    </motion.div>
                        ...
                        {contributeItems.map((item, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p className="mt-2 text-sm text-neutral-500 leading-relaxed flex-1">{item.description}</p>
                                    <a
                                        href={item.href}
                                        target="_blank"
                                        rel="noopener noreferrer"
            ...
            <section className="py-16 bg-neutral-50 border-t border-neutral-200">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="mt-3 text-sm sm:text-base text-neutral-500 max-w-2xl leading-relaxed">
                            All information published on BetterLibmanan is sourced from official public government portals.
                            We do not create or modify primary data.
                        </p>
                    </motion.div>

                    <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                        {[
                            { name: 'Commission on Audit (COA)', href: 'https://www.coa.gov.ph' },
                            { name: 'DBM Open Data Portal', href: 'https://opendata.dbm.gov.ph' },
                            { name: 'Open Data Philippines', href: 'https://data.gov.ph' },
                            { name: 'Freedom of Information (FOI)', href: 'https://foi.gov.ph' },
                            { name: 'BLGF Portal', href: 'https://blgf.gov.ph' },
                            { name: 'Official Gazette of the Philippines', href: 'https://www.officialgazette.gov.ph' },
                        ].map((source, index) => (
                            <motion.a
                                key={source.name}
                                href={source.href}
                    ...
                    <motion.p {...fadeUpDelay(0.4)} className="mt-6 text-xs text-neutral-400 max-w-2xl leading-relaxed">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <motion.div {...fadeUp} className="text-center">
                        ...
                        <p className="mt-3 text-sm sm:text-base text-gray-400 max-w-xl mx-auto leading-relaxed">
                            This platform will always be free. Join hundreds of civic-minded Filipinos who believe
