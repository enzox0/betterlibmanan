...
function DiscussionCard({ discussion, index }: { discussion: Discussion; index: number }) {
  return (
    <motion.div
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs font-semibold text-neutral-600">{discussion.author}</span>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 p-4 flex flex-col justify-between gap-2">
        <div>
          <h3 className="text-sm font-bold text-neutral-900 leading-snug">{group.name}</h3>
...
export function CommunitySection() {
  ...
  const handleAddTag = () => {
    ...
    if (!tag) return;
    if (newTags.includes(tag)) { setNewTagInput(''); return; }
    if (newTags.length >= 4) { toast('Max 4 tags allowed', 'error'); return; }
    setNewTags(prev => [...prev, tag]);
    setNewTagInput('');
  };

  const handlePostDiscussion = () => {
    if (!newTitle.trim()) { toast('Please enter a discussion title.', 'error'); return; }
          ...
          <aside className="w-full lg:w-72 xl:w-80 shrink-0 flex flex-col gap-4">
            ...
            >
              ...
              <p className="text-gray-400 text-xs leading-relaxed mb-4">
                Join your local officials and neighbors to discuss upcoming projects and community plans.
              </p>
              <button
                onClick={() => toast('Registration noted. Stay tuned for updates.', 'success')}
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-bold text-sm text-neutral-900">Trending Hashtags</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-bold text-sm text-neutral-900">People to Follow</h3>
              </div>
              <div className="flex flex-col gap-3">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-base font-bold text-neutral-900">Start a Discussion</h2>
                </div>
                <button
                  onClick={closeModal}
                  style={{ minHeight: 0 }}
              ...
              {/* Tags */}
              <label className="block mb-1 text-xs font-semibold text-neutral-500 uppercase tracking-wide">
                Tags <span className="normal-case font-normal">(optional, max 4)</span>
              </label>
