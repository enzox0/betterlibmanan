import { GovernmentData } from "../types/types";

export const mockGovernmentData: GovernmentData = {
  executive: [
    {
  ...
  barangays: [
    { name: "Barangay 1", captain: "Kap. [Name]", phone: "[Phone Number]" },
    { name: "Barangay 2", captain: "Kap. [Name]", phone: "[Phone Number]" },
    { name: "Barangay 3", captain: "Kap. [Name]", phone: "[Phone Number]" },
  ],
};
